...
def main_behavioral():
    FILE = r"C:\Users\user1\Documents\MRI_project\ADD_variables_means_sig.csv"
    SEX_ATTRIBUTE = 'bio_sex'
    MALE, FEMALE = '1', '2'
    NOT_ATTRIBUTE = '', 'bio_sex'
    ...
    f = file("attrib_threshold_behavioral.txt", 'wt')
    for attribute, histogram in attrib_dict.iteritems():
        print_threshold(f, attribute, histogram[MALE], histogram[FEMALE])
    f.close()
...
def main_brain():
    FEMALE_FILE = r'C:\Users\user\Documents\MRI_project\cluster_analysis\whole_area_density\whole_area_density_larger_sample_0314_females.csv'
    MALE_FILE = r'C:\Users\user\Documents\MRI_project\cluster_analysis\whole_area_density\whole_area_density_larger_sample_0314_males.csv'
    MALE, FEMALE = '1', '2'
    ...
    f1 = file("attrib_threshold_whole_area_density_mean_0314.txt", 'wt')
    f2 = file("attrib_threshold_whole_area_density_mean_0314_xsl.txt", 'wt')
...
def main_extremelly_sex_typed():
    FEMALE_FILE = r'C:\Users\user\Documents\MRI_project\cluster_analysis\whole_area_density_mean_females.csv'
    MALE_FILE = r'C:\Users\user\Documents\MRI_project\cluster_analysis\whole_area_density_mean_males.csv'
    MALE, FEMALE = '1', '2'
